        ...
        >
            <div className="flex h-16 items-center border-b border-slate-800 px-4">
                <div className="flex items-center gap-2 font-semibold text-slate-100">
                    ...
                    {!collapsed && <span className="animate-in fade-in duration-300">Email Hub</span>}
                </div>
            </div>
            ...
            <div className="border-t border-slate-800 p-2">
                ...
                >
                    {collapsed
                        ...
                        : <div className="flex items-center w-full"><ChevronLeft className="h-5 w-5 mr-3" /><span>Collapse</span></div>
                    }
                </button>
            </div>
        </aside>

...
Environment Variables:
    ...
    MCP_PORT: Port for HTTP/SSE. Default: 10813
...
Environment Variables:
  ...
  {ENV_PORT}         Port number (default: 10813)
...
""",
    ...
    parser.add_argument("--port", type=int, default=None, help=f"Port to listen on (default: ${ENV_PORT} or 10813)")

...
description: Email MCP session awareness — SMTP/IMAP, SendGrid, Mailgun, Resend, mailing lists
---
...
- Use `mailing_list_latest()` to stay current on subscribed newsletters
